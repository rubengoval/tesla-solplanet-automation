# app.py (VFinal v3 - Versão para Background Worker)
...
def get_solplanet_data():
    ...
    # ... (a lógica da Solplanet continua igual)
    return 0
...
def main():
    """Função principal que prepara e inicia o ciclo."""
    print("A inicializar a automação...")
